...
static void oct(char str[], UI32 *i, UI32 *j, UI32 offset) {
	char O[6] = { [0 ... 5]=Z0 };
	UI32 o[3];
...
static void uni4(char str[], UI32 *i, UI32 *j) {
	char U[8] = {[0 ... 7]=Z0};
	UI32 x[8];
	UI32 xval;
...
static void uni8(char str[], UI32 *i, UI32 *j) {
	char U[16] = {[0 ... 15]=Z0};
	UI32 x[8];
	UI32 xval;
	U[0]=str[*i+2];		U[2]=str[*i+3];
